...
race_terms <- c("Urm|Race|Ethnicity|Ethnic|Black|Asian|Native|Indige|Hurm|Immigrant|Racial|Latin|Hispanic|Minority|Racism|African")

black_terms <- c("Black|Hurm|Racism|African")

disabil_terms <- c("Disabil|Abili|Deaf|Blind|Wheelchair|Autis|Neuro|Accessibility|Mental Illness|Ablism|Impaired|Adhd|Disable")

women_terms <- c("Gender|Wom.n|Female")

edu_terms <- c("Education|Academic|High School|Elementary|Middle School|School|College| Undergrad|Classroom|Learning|Pedagog|Teach|Instruct|Curric|Affirmative Action|Campus")

health_terms <- c("Healthcare|Health|Care|Physician|Illness|Disease|Pain|Medic|Provid|Nurse|Doctor|Resident|Patient|Treat|Surg|Perscri|Sex.Related|Therap")
...
law_terms <- c("Law|Enforce|Police|Jail|Incarc|Prison|Policy|Policing|Carc")

environ_terms <- c("Pollution|Climate|Weather|Urban|Solar")
