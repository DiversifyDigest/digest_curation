...
#Category terms----
LGBT_terms <- c("Lgbt|Trans|Queer|Sexual Minorit|Gender Minorit|Gender Ident|Sexual Orientation")

race_terms <- c("Urm|Race|Ethnicity|Ethnic|Black|Asian|Native|Indigenous|Hurm|Immigrant|Racial|Latin|Hispanic|Minority|Racism")
...
health_terms <- c("Healthcare|Health|Care|Physician|Illness|Disease")

acad_terms <- c("Grad|Postdoc|Faculty|Academia|Research|Academy|Journal|Publish|Public|Cite|Citation|Author|Academic|Peer Review|Higher Ed")
