...
health_terms <- c("Healthcare|Health|Care|Physician|Illness|Disease|Pain|Medic|Provid|Nurse|Doctor|Resident|Patient|Treat|Surg|Perscri|Sex.Related")
...
environ_terms <- c("Pollution|Climate|Weather")
