...
edu_terms <- c("Education|Academic|High School|Elementary|Middle School|School|College Grad|Classroom|Learning|Pedagog|Teach|Instruct|Curric")

health_terms <- c("Healthcare|Health|Care|Physician|Illness|Disease|Pain|Medic|Provid|Nurse|Doctor|Resident")

acad_terms <- c("Grad|Postdoc|Faculty|Academia|Research|Academy|Journal|Publish|Public|Cite|Citation|Author|Academic|Review|Higher Ed|Peer Review|Lit")
